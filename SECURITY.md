...
WinRocket takes security very seriously, if you believe you have found a security vulnerability within WinRocket, do the following steps:
...
3. Send an email to `misha.starrrr@gmail.com` with the subject line `[SECURITY] Example Vulnerability`
